...
function retrieveDeps(name, version, prerelease, registry, callback) {
    // retriveing queue
        ...
        if (queue.length > 0) {
            ...
            request([registry, splited[0], splited[1]].join('/'), function(err, res, json) {
                ...
                if (res.statusCode != 200) {
                    ...
                    var dependencies;
                    if (json.cortex && json.cortex.dependencies)
                        dependencies = lang.object_member_by_namespaces(json, 'cortex.dependencies', {});
                    else
...
module.exports = function(options, callback) {
    ...
    retrieveDeps(name, version, options.prerelease, options.registry, function(err, info) {
